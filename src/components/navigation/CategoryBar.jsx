    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
        ...
        <button
          ...
          className={`shrink-0 inline-flex items-center gap-2 px-4 py-2 rounded-full text-xs font-bold border transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-purple-500/50 ${
        ...
        >
          ...
          {bookmarkedCount > 0 && (
            <span className="px-1.5 py-0.2 bg-purple-500/30 text-purple-200 text-[10px] rounded-full font-bold">
              {bookmarkedCount}
            </span>
          )}
        </button>
