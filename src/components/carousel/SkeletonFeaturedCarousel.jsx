...
export function SkeletonFeaturedCarousel() {
  return (
    <div className="relative max-w-7xl mx-auto px-4 md:px-8 pt-6 pb-2">
      <div className="relative w-full h-[340px] sm:h-[400px] lg:h-[440px] rounded-3xl overflow-hidden bg-[#12101F] border border-purple-500/15 p-6 sm:p-10 flex flex-col justify-end">
